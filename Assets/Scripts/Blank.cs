...
public class Blank : MonoBehaviour
{
    ...
    void OnGUI()
    {
        ...
        GUI.DrawTexture(new Rect(Screen.width / 2 - 120 , Screen.height / 2 - 200, 240, 60), storyTexture);
        ...
        scrollViewVector = GUI.BeginScrollView (new Rect (Screen.width / 2 - 200 , Screen.height / 2 - 120, 425, 240), scrollViewVector, new Rect (Screen.width / 2 - 205 , Screen.height / 2 - 120, 425, 700));
    
        //JR Text area that holds StoryText string
        StoryText = GUI.TextArea (new Rect (Screen.width / 2 - 200 , Screen.height / 2 - 120, 400, 700), StoryText);
